                ...
                <div class="col-md-auto mb-6 mb-md-0">
                    <div class="p-3 border border-width-2 border-primary borders-radius-20 bg-white min-width-370">
                        <div class="d-flex justify-content-between align-items-center m-1 ml-2">
                            <h3 class="font-size-22 mb-0 font-weight-normal text-lh-28 max-width-120">DLP Projector
                            </h3>
                            <div class="d-flex align-items-center flex-column justify-content-center bg-primary rounded-pill height-75 width-75 text-lh-1">
                                <span class="font-size-12">New</span>
                                <div class="font-size-20 font-weight-bold">Arrival</div>
                            </div>
                        </div>
                        <div class="mb-4">
                            <a href="#" class="d-block text-center"><img class="img-fluid" src="<?php echo base_url(); ?>assets/theme2/img/320X300/img1.jpg" alt="Image Description"></a>
                        </div>
                        <h5 class="mb-2 font-size-14 text-center mx-auto max-width-180 text-lh-18"><a href="." class="text-blue font-weight-bold">WIFI Connect + HDMI Port
                                + HDMI Port + USB Function
                                            ...
                                            <div class="product-item__outer h-100">
                                                <div class="product-item__inner px-xl-4 p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        ...
                                                        <h5 class="mb-1 product-item__title"><a href="" class="text-blue font-weight-bold"><?php echo $productt['title']; ?></a></h5>
                                                        <div class="mb-2">
                                                            <a href="" class="d-block text-center"><img class="img-fluid" src="<?php echo base_url(); ?>assets/theme2/images/testproduct/<?php echo $productt['img'][0]; ?>" alt="Image Description"></a>
                                                        </div>
